	...
	$('#gform-jquery').submit(function(e){ // вешаем событие на отправку формы
		...
		$.ajax({ // инициализируем аякс
            url: "https://docs.google.com/forms/d/e/1FAIpQLSfPz8VJZZAw61rzR5Nvi5M_MlHaOqXoRpWtU9EN-FN9sDGoXA/formResponse", // слать надо сюда, строку с буковками надо заменить на вашу, это атрибут action формы
            ...
            statusCode: { // после того как пришел ответ от сервера
                0: function (){ // это успешный случай
                	form.html('<div class="thank"><h2>Спасибо!</h2><p>Заявка отправлена </p></div>'); // сунем в форму сообщение что все ок
                },
